package com.basic.twelve;

import com.basic.thirteen.Account;
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (true) {
            ...
            if (locatedIndex == -1) {
                ...
                //Lets check if the person has enough money to buy the product
                //if so deduct the balance and insert the items
                double totalCost = prices[locatedIndex] * requestedQuantity; // can be done as * (new Double(requestedQuantity)
